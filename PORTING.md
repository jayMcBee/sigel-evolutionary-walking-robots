...
**Exit criterion per step:** `./check.sh` at the repo root — **853 pass, 0 fail,
508 warnings** as of 2026-09-08, after the `truncated pi (V5)` section.
...
```
./check.sh                                            853 pass, 0 fail, exit 0
