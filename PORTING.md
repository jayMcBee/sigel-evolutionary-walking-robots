...
**Exit criterion per step:** `./check.sh` at the repo root — **852 pass, 0 fail,
508 warnings** as of 2026-09-08, after the `v2 round trip vs 1.3` section.
...
Re-counted from `check.sh` 2026-09-08, site by site — lines 618, 685, 757,
1106 (twelve), 1398, 1484 (two) and 1716 (four). Count it again; do not
increment it.*  — the slave's
...
```
./check.sh                                            852 pass, 0 fail, exit 0
