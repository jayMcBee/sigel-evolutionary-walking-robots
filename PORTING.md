...
**Exit criterion per step:** `./checks/check.sh` from anywhere — **964 pass, 0
...
when `gui vs 1.3` and `guidump-baseline.txt` went, one pass each.*
...
**2026-09-24, night — DONE: SEVEN CHECKS DROPPED FROM `check.sh`.** Start here.
