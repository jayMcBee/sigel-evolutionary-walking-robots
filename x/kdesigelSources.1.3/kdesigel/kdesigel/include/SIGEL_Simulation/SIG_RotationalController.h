...
*/
#ifndef SIGEL_SIMULATION_SIG_ROTATIONALCONTROLLER_H
#define SIGEL_SIMULATION_SIG_ROTATIONALCONTROLLER_H
 ...
 */
class SIG_RotationalController : public DL_controller {
...
#endif // SIGEL_SIMULATION_SIG_ROTATIONALCONTROLLER_H
