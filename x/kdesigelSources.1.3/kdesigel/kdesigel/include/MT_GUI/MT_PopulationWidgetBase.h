/*
  ...
  mode (`uic3 MT_PopulationWidgetBase.ui`, tools/qtmig), with the Qt 6 adjustments
  C1 lists. Qt 6's uic emits only Ui::MT_PopulationWidgetBase, a struct with setupUi().
