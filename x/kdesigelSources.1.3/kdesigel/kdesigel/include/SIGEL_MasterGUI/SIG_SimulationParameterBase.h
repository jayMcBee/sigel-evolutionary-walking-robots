/*
  ...
  mode (`uic3 SIG_SimulationParameterBase.ui`, tools/qtmig), with the Qt 6 adjustments
  C1 lists. Qt 6's uic emits only Ui::SIG_SimulationParameterBase, a struct with setupUi().
