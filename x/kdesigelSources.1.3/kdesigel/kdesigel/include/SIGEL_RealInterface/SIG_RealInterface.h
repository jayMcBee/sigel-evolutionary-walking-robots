 ...
 * modeled by the class SIGEL_Program::SIG_Program to any
 * special robot control program format.
 */
namespace SIGEL_RealInterface
{ }

#endif // SIGEL_REALINTERFACE_SIG_REALINTERFACE_H
