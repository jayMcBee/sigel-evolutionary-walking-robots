...
namespace SIGEL_Robot {
        ...
        SIG_ContactSensor::SIG_ContactSensor (SIG_Robot *par, QTextStream & tx)
                : SIG_Sensor (par, tx)
        {
			QString myLink;
        ...
        void SIG_ContactSensor::setLink(SIG_Link *j)
        {
                theLink = j;
        }
        ...
        void SIG_ContactSensor::writeToFileTransfer (QTextStream & tx)
        {
			tx << "ContactSensor ";
