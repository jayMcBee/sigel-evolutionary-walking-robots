...
*/
#include "SIGEL_GP/SIG_GPZorcWalkingFitnessFunction.h"
...
namespace SIGEL_GP
{
  ...
  SIG_GPZorcWalkingFitnessFunction::SIG_GPZorcWalkingFitnessFunction( SIGEL_Program::SIG_Program &program,
  ...
  SIG_GPZorcWalkingFitnessFunction::~SIG_GPZorcWalkingFitnessFunction()
  { };

  double SIG_GPZorcWalkingFitnessFunction::evalFitness()
  {
    double  fitness   = 0,
            avgHeight = 0,
            avgHeightPercent = 0;
    ...
    *endRotation = recorder.endRotation;
    ...
    while (actPosition)
        ...
        {   SIGEL_Tools::SIG_IO::cerr << "\to quite high -- " << actRealPosition.y << "\n";
				...
				{   SIGEL_Tools::SIG_IO::cerr << "\t## r u ready 2 fly ?  ##  height is > 2*startHeight  (actRealPosition.y=" << actRealPosition.y << " ##\n";
				}
			}
  	...
  	fitness *= avgHeightPercent;

		fprintf(stderr, "avgHeight: %4.1f%% | distance: %4.3f | fitness: %5.4f\n", avgHeightPercent*100.0, distance, fitness);
