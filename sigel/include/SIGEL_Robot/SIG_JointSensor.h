...
*/
#ifndef SIGEL_ROBOT_SIG_JOINTSENSOR_H
#define SIGEL_ROBOT_SIG_JOINTSENSOR_H

namespace SIGEL_Robot { class SIG_JointSensor; }
...
namespace SIGEL_Robot {
   ...
   */
  class SIG_JointSensor : public SIG_Sensor {
  private:
    SIG_Joint *theJoint;
